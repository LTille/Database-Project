...
<html lang="en">
    ...
    <body>
        ...
        $sql_order = "SELECT * FROM C_Order, OPDetail, CEDetail, Store, Product, Region WHERE C_Order.orderID = OPDetail.order_id AND C_Order.em_id = CEDetail.em_id AND Product.productID = OPDetail.product_id AND Product.category_id = CEDetail.category_id AND CEDetail.store_id = Store.storeID AND Store.regionID = Region.regionID AND Region.rg_manager = '".$_SESSION['empID']."'";
